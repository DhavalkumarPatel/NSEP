function validation()
{	
	var loanId=document.UpdateInstallment.txtLoanId.value;
	var studentId=document.UpdateInstallment.txtStudentId.value;
	var amount=document.UpdateInstallment.txtAmount.value;
	var amountFloat=parseFloat(amount);
	var repaymentDate=document.UpdateInstallment.txtRepaymentDate.value;
	...
	if(retrn)
	{
		var con=confirm("Do you Want to Update the Details?");
		if (con==false)
		  {
			return false;
		  }
