...
<head>
	...
	<title>Create Loan Account</title>
 	...
 	<script type="text/javascript" src="/NSEP_System/HTML/Loan_Management/Loan_Account/addLoanAccount1.js">
	</script>
...
%>
<body onload="document.myform.loan_id.focus()">
  <div id="main">
    <div id="header">
      <div id="logo">
        <div id="logo_text">
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<form name="myform" method="post" onsubmit="return validation()" onreset="get_reset()" action="/NSEP_System/LoanAccount" class="form_settings">			
			...
			<tr>
				<td> Enter Loan ID : </td>
				<td> <input type="textbox" id="loan_id" name="loan_id" size="10" maxlength="9" onfocus="focusColor(this)" onblur="blurColor(this)"> <label id="loan_id_label"><%= msg %></label></td>
			</tr>			
			<tr >
			...
			<input type="hidden" name="h_field" value="add1"></input>
			</form>
