...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1>Loan Account Updated Successfully</h1>
		
		<form name="myform" method="post" action="loanAccountMenu.html" class="form_settings">
			<table>
			<tr>
				<td><input type="submit" value="Exit" class="submit" /></td>
			</tr>
			</table>
