...
<head>
	...
	<title>View Loan Account</title>
 	...
 	<script type="text/javascript" src="/NSEP_System/HTML/Loan_Management/Loan_Account/viewLoanAccount1.js">
	</script>
</head>
<%
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
		...
		<form name="myform" method="post" action="/NSEP_System/LoanAccount" class="form_settings">
			<table>
			<tr>
				<td> Enter Loan ID : </td>
			...
			<tr>
				<td> <input type="submit" value="Submit" onclick= "return validation()" class="submit"/></td>
				<td><input type="reset" value="Reset" onclick="return callReset()" class="submit"/></td>
			</tr>
			<tr>
				<td> <input type="submit" value="View All Data" onclick="viewList()" class="submit" /></td>
			</tr>			
			</table>
			<input type="hidden" name='h_field' value="vew1"></input>
			</form>
