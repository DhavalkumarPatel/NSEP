...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1>Loan Account Created Successfully</h1>
		
		<form name="myform" method="post" action="addLoanAccount1.html" class="form_settings">
			<table>
			<tr>
				<td><input type="submit" value="Create Account" class="submit" /></td>
				<td><input type="reset" value="Exit" onclick="loanAccountMenu.html" class="submit" /></td>
			</tr>
			</table>
			<input type="hidden" name="h_field" value="add3"></input>
			</form>
